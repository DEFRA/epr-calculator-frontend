    ...
    public static class MockData
    {
        ...
        public static IEnumerable<CalculationRun> GetCalculationRuns()
        {
            ...
            calculationRuns.AddRange([
                new CalculationRun { Id = 1, CalculatorRunClassificationId = Enums.RunClassification.INTHEQUEUE, Name = "Default cettings check", CreatedAt = DateTime.Parse("28/06/2025 10:01:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 2, CalculatorRunClassificationId = Enums.RunClassification.RUNNING, Name = "Alteration check", CreatedAt = DateTime.Parse("28/06/2025 12:19:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 3, CalculatorRunClassificationId = Enums.RunClassification.UNCLASSIFIED, Name = "Test 10", CreatedAt = DateTime.Parse("21/06/2025 12:09:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 4, CalculatorRunClassificationId = Enums.RunClassification.TEST_RUN, Name = "June check", CreatedAt = DateTime.Parse("11/06/2025 09:14:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 5, CalculatorRunClassificationId = Enums.RunClassification.TEST_RUN, Name = "Pre June check", CreatedAt = DateTime.Parse("13/06/2025 11:18:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 6, CalculatorRunClassificationId = Enums.RunClassification.TEST_RUN, Name = "Local Authority data check 5", CreatedAt = DateTime.Parse("10/06/2025 08:13:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 7, CalculatorRunClassificationId = Enums.RunClassification.TEST_RUN, Name = "Local Authority data check 4", CreatedAt = DateTime.Parse("10/06/2025 10:14:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
                new CalculationRun { Id = 8, CalculatorRunClassificationId = Enums.RunClassification.TEST_RUN, Name = "Local Authority data check 3", CreatedAt = DateTime.Parse("08/06/2025 10:00:00", new CultureInfo("en-GB")), CreatedBy = "Jamie Roberts", Financial_Year = "2024-25" },
