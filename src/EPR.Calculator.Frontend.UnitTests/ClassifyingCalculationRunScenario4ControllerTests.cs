...
{
    [TestClass]
    public class ClassifyingCalculationRunScenario4ControllerTests
    {
        private readonly IConfiguration _configuration = ConfigurationItems.GetConfigurationValues();
        private Mock<IHttpClientFactory> _mockHttpClientFactory;
        private Mock<ILogger<ClassifyingCalculationRunScenario4Controller>> _mockLogger;
        private Mock<ITokenAcquisition> _mockTokenAcquisition;
        private TelemetryClient _telemetryClient;
        private Mock<HttpContext> _mockHttpContext;
        private ClassifyingCalculationRunScenario4Controller _controller;

        public ClassifyingCalculationRunScenario4ControllerTests()
        {
            ...
            _mockLogger = new Mock<ILogger<ClassifyingCalculationRunScenario4Controller>>();
        ...
        public void Setup()
        {
            _controller = new ClassifyingCalculationRunScenario4Controller(
               _configuration,
        ...
        public async Task IndexAsync_ReturnsView_WhenRunExists()
        {
            ...
            Assert.AreEqual(ViewNames.ClassifyingCalculationRunScenario4Index, viewResult.ViewName);

            var model = viewResult.Model as ClassifyCalculationRunScenerio4ViewModel;
