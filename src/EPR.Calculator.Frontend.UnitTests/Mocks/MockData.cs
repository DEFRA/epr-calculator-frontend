    ...
    public static class MockData
    {
        public static IEnumerable<SchemeParameterTemplateValue> GetSchemeParameterTemplateValues() =>
            [
                ...
                new SchemeParameterTemplateValue { ParameterUniqueReferenceId = "COFF-DT", ParameterValue = "01/09/2026" },
            ];
        ...
        public static string GetSchemeParametersFileContent()
        {
            return string.Concat(
                ...
                "COFF-DT,Cut-off date,Optional Date,,,01/09/2026,",
        ...
        public static IEnumerable<DefaultSchemeParameters> GetDefaultParameterValues() =>
            [
                new() { ParameterUniqueRef = "COMC-AL",   ParameterValue = "2210.45"   , ParameterCategory = "Aluminium", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 5, 28, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new (2024, 5, 28, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-FC",   ParameterValue = "2210.00"   , ParameterCategory = "Fibre composite", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 5, 29, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 5, 29, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-GL",   ParameterValue = "2210.00"   , ParameterCategory = "Glass", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 5, 30, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 5, 30, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-PC",   ParameterValue = "2210.00"   , ParameterCategory = "Paper or card", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 5, 30, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "OMC-PL",    ParameterValue = "2210.00"   , ParameterCategory = "Plastic", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-ST",   ParameterValue = "2210.00"   , ParameterCategory = "Steel", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-WD",   ParameterValue = "2210.00"   , ParameterCategory = "Wood", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-OT",   ParameterValue = "0.00"      , ParameterCategory = "Other", ParameterType = "Communication costs by material", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-UK",   ParameterValue = "0.00"      , ParameterCategory = "United Kingdom", ParameterType = "Communication costs by country", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-ENG",  ParameterValue = "115.45"    , ParameterCategory = "England", ParameterType = "Communication costs by country", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-WLS",  ParameterValue = "114.00"    , ParameterCategory = "Wales", ParameterType = "Communication costs by country", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 28, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-SCT",  ParameterValue = "117.00"    , ParameterCategory = "Scotland", ParameterType = "Communication costs by country", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COMC-NIR",  ParameterValue = "19.00"     , ParameterCategory = "Northern Ireland", ParameterType = "Communication costs by country", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SAOC-ENG",  ParameterValue = "500.00"    , ParameterCategory = "England", ParameterType = "Scheme administrator operating costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 1, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SAOC-WLS",  ParameterValue = "140.55"    , ParameterCategory = "Wales", ParameterType = "Scheme administrator operating costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 2, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 2, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SAOC-SCT",  ParameterValue = "170.00"    , ParameterCategory = "Scotland", ParameterType = "Scheme administrator operating costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 3, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 3, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SAOC-NIR",  ParameterValue = "90.00"     , ParameterCategory = "Northern Ireland", ParameterType = "Scheme administrator operating costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 4, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 4, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LAPC-ENG",  ParameterValue = "115.45"    , ParameterCategory = "England", ParameterType = "Local authority data preparation costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 5, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 5, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LAPC-WLS",  ParameterValue = "114.00"    , ParameterCategory = "Wales", ParameterType = "Local authority data preparation costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 9, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 9, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LAPC-SCT",  ParameterValue = "117.00"    , ParameterCategory = "Scotland", ParameterType = "Local authority data preparation costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LAPC-NIR",  ParameterValue = "19.00"     , ParameterCategory = "Northern Ireland", ParameterType = "Local authority data preparation costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 18, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SCSC-ENG",  ParameterValue = "325.55"    , ParameterCategory = "England", ParameterType = "Scheme setup costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 19, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 19, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SCSC-WLS",  ParameterValue = "314.00"    , ParameterCategory = "Wales", ParameterType = "Scheme setup costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 23, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 23, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SCSC-SCT",  ParameterValue = "317.00"    , ParameterCategory = "Scotland", ParameterType = "Scheme setup costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 6, 28, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 6, 28, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "SCSC-NIR",  ParameterValue = "391.10"    , ParameterCategory = "Northern Ireland", ParameterType = "Scheme setup costs", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 10, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 10, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-AL-R", ParameterValue = "170.55"    , ParameterCategory = "Aluminium-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 12, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 12, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-AL",   ParameterValue = "70.55"     , ParameterCategory = "Aluminium-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 12, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 12, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-AL-G", ParameterValue = "270.55"    , ParameterCategory = "Aluminium-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 12, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 12, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-FC-R", ParameterValue = "180.00"    , ParameterCategory = "Fibre composite-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 14, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 14, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-FC",   ParameterValue = "80.00"     , ParameterCategory = "Fibre composite-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 14, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 14, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-FC-G", ParameterValue = "280.00"    , ParameterCategory = "Fibre composite-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 14, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 14, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-GL-R", ParameterValue = "160.00"    , ParameterCategory = "Glass-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-GL",   ParameterValue = "60.00"     , ParameterCategory = "Glass-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-GL-G", ParameterValue = "260.00"    , ParameterCategory = "Glass-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-PC-R", ParameterValue = "150.00"    , ParameterCategory = "Paper or card-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-PC",   ParameterValue = "50.00"     , ParameterCategory = "Paper or card-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-PC-G", ParameterValue = "250.00"    , ParameterCategory = "Paper or card-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 16, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-PL-R", ParameterValue = "140.00"    , ParameterCategory = "Plastic-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 18, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-PL",   ParameterValue = "40.00"     , ParameterCategory = "Plastic-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 18, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-PL-G", ParameterValue = "240.00"    , ParameterCategory = "Plastic-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 18, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-ST-R", ParameterValue = "130.00"    , ParameterCategory = "Steel-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 20, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 20, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-ST",   ParameterValue = "30.00"     , ParameterCategory = "Steel-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 20, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 20, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-ST-G", ParameterValue = "230.00"    , ParameterCategory = "Steel-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 20, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 20, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-WD-R", ParameterValue = "120.00"    , ParameterCategory = "Wood-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 21, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 21, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-WD",   ParameterValue = "20.00"     , ParameterCategory = "Wood-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 21, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 21, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-WD-G", ParameterValue = "220.00"    , ParameterCategory = "Wood-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 21, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 21, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-OT-R", ParameterValue = "1.00"      , ParameterCategory = "Other-R", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 23, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 23, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-OT",   ParameterValue = "0.00"      , ParameterCategory = "Other-A", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 23, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 23, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "LRET-OT-G", ParameterValue = "2.00"      , ParameterCategory = "Other-G", ParameterType = "Late reporting tonnage", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 7, 23, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 7, 23, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "BADEBT-P",  ParameterValue = "5.25"      , ParameterCategory = "Percentage", ParameterType = "Bad debt provision", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 24, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 24, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "MATT-AI",   ParameterValue = "5000.00"   , ParameterCategory = "Amount Increase", ParameterType = "Materiality threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 26, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 26, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "MATT-AD",   ParameterValue = "-1000.00"  , ParameterCategory = "Amount Decrease", ParameterType = "Materiality threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 27, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 27, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "MATT-PI",   ParameterValue = "2.00"      , ParameterCategory = "Percent Increase", ParameterType = "Materiality threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 10, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 10, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "MATT-PD",   ParameterValue = "-1.00"     , ParameterCategory = "Percent Decrease", ParameterType = "Materiality threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 12, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 12, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "TONT-AI",   ParameterValue = "50.00"     , ParameterCategory = "Amount Increase", ParameterType = "Tonnage change threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 13, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 13, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "TONT-AD",   ParameterValue = "-10.00"    , ParameterCategory = "Amount Decrease", ParameterType = "Tonnage change threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 15, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 15, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "TONT-PI",   ParameterValue = "2.00"      , ParameterCategory = "Percent Increase", ParameterType = "Tonnage change threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 17, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 17, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "TONT-PD",   ParameterValue = "-0.50"     , ParameterCategory = "Percent Decrease", ParameterType = "Tonnage change threshold", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 18, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "REDM-RF",   ParameterValue = "1.200"     , ParameterCategory = "Modulation Factor", ParameterType = "Red modulation factor", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 18, 10, 12, 30, DateTimeKind.Utc) },
                new() { ParameterUniqueRef = "COFF-DT",   ParameterValue = "01/09/2026", ParameterCategory = "Optional Date", ParameterType = "Cut-off date", RelativeYear =  new RelativeYear(2024), EffectiveFrom = new DateTime(2024, 8, 18, 10, 12, 30, DateTimeKind.Utc), CreatedBy = "Test User", CreatedAt = new DateTime(2024, 8, 18, 10, 12, 30, DateTimeKind.Utc) },
            ];
        ...
        public static IEnumerable<CalculatorRunDto> GetCalculationRuns()
        {
            return
            [
